...
По умолчанию OpenCode работает как **CEO** проекта Русский Ритм:
...
- Сайт Русский Ритм — лендинг для привлечения клиентов.
- Основной продукт — Школа социальных танцев в Анапе.
